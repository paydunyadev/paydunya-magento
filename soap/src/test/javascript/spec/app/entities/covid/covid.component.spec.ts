...
import { CovidComponent } from 'app/entities/covid/covid.component';
  ...
  describe('Covid Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CovidComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.covids && comp.covids[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
